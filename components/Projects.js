...
const Projects = () => {
  ...
  return (
    <>
      <div className='w-full relative bg-white h-screen min-h-[90vh] flex items-center py-10 px-5'>
        <div
          className='w-full bg-white max-w-[1320px] mx-auto flex flex-col md:flex-row justify-between items-center md:items-stretch gap-6'
          ref={card1.ref}
        >
